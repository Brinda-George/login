...
namespace WebFormTest1
{
    public partial class ResetPassword : System.Web.UI.Page
    {
        ...
        private void SendPasswordResetEmail(string ToEmail, string UserName, string UniqueId)
        {
            ...
            MailMessage mailMessage = new MailMessage("brindageorge94@gmail.com", ToEmail);

            // StringBuilder class is present in System.Text namespace
            StringBuilder sbEmailBody = new StringBuilder();
            sbEmailBody.Append("Dear " + UserName + ",<br/><br/>");
            sbEmailBody.Append("Please click on the following link to reset your password");
            sbEmailBody.Append("<br/>"); sbEmailBody.Append("http://localhost:49587/Registeration/ChangePassword.aspx?uid=" + UniqueId);
            sbEmailBody.Append("<br/><br/>");
            sbEmailBody.Append("<b>Brinda George</b>");
